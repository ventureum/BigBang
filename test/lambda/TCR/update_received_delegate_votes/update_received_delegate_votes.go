package update_received_delegate_votes_test
...
func TestHandler(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			request: lambda_update_received_delegate_votes_config.Request{
				...
				Body: lambda_update_received_delegate_votes_config.RequestContent{
	...
	for _, test := range tests {
		result, err := lambda_update_received_delegate_votes_config.Handler(test.request)
