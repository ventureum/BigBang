...
CREATE INDEX post_votes_records_index ON post_votes_records (uuid, actor, post_hash, vote_type, delta_fuel, delta_reputation, delta_milestone_points, signed_reputation, created_at);
`
