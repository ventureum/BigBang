...
func (milestoneValidatorRecordExecutor *MilestoneValidatorRecordExecutor) UpsertMilestoneValidatorRecord(milestoneValidatorRecord *MilestoneValidatorRecord) {
  _, err := milestoneValidatorRecordExecutor.C.NamedExec(UPSERT_MILESTONE_VALIDATOR_RECORD_COMMAND, milestoneValidatorRecord)
  if err != nil {
...
func (milestoneValidatorRecordExecutor *MilestoneValidatorRecordExecutor) DeleteMilestoneValidatorRecordsByProjectIdAndMilestoneId(
    projectId string, milestoneId int64) {
  _, err := milestoneValidatorRecordExecutor.C.Exec(
...
func (milestoneValidatorRecordExecutor *MilestoneValidatorRecordExecutor) DeleteMilestoneValidatorRecordByIDsAndValidator(
...
func (milestoneValidatorRecordExecutor *MilestoneValidatorRecordExecutor) GetMilestoneValidatorListByProjectIdAndMilestoneId(
    projectId string, milestoneId int64) *[]string {
  var milestoneValidatorList []string
  err := milestoneValidatorRecordExecutor.C.Select(
