...
func (postVotesCountersRecordExecutor *PostVotesCountersRecordExecutor) UpsertPostVotesCountersRecord (
...
func (postVotesCountersRecordExecutor *PostVotesCountersRecordExecutor) DeletePostVotesCountersRecordsByPostHash(postHash string) {
  _, err := postVotesCountersRecordExecutor.C.Exec(DELETE_POST_VOTES_COUNTRS_RECORDS_BY_POST_HASH_COMMAND, postHash)
  if err != nil {
