...
cd $GOPATH/src/BigBang/cmd/lambda/get_recent_posts/
GOOS=linux go build -o main
zip get_recent_posts.zip main
#
#aws lambda create-function \
#    --region ca-central-1 \
#    --function-name get_recent_posts_v3_test \
#    --zip-file fileb://$GOPATH/src/BigBang/cmd/lambda/get_recent_posts/get_recent_posts.zip \
...
mv get_recent_posts.zip $GOPATH/src/BigBang/assets/lambda_zips
rm -rf main
