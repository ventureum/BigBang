...
echo "adding lambda permission for set_token_pool"
.//add_feed_lambda_permission.sh set_token_pool $1 $2 set-token-pool

echo "adding lambda permission for set_next_redeem"
.//add_feed_lambda_permission.sh set_next_redeem $1 $2 set-next-redeem

echo "adding lambda permission for get_next_redeem"
.//add_feed_lambda_permission.sh get_next_redeem $1 $2 get-next-redeem

echo "adding lambda permission for get_redeem_history"
.//add_feed_lambda_permission.sh get_redeem_history $1 $2 get-redeem-history

echo "adding lambda permission for get_redeem_block_info"
.//add_feed_lambda_permission.sh get_redeem_block_info $1 $2 get-redeem-block-info
