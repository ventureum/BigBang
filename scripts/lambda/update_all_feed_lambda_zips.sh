...
.//update_lambda_zip.sh feed get_actor_private_key $1 $2

echo "updating get_actor_uuid_from_public_key zip"
.//update_lambda_zip.sh feed get_actor_uuid_from_public_key $1 $2
...
.//update_lambda_zip.sh feed set_actor_private_key $1 $2
