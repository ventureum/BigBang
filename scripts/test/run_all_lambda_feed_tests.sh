...
./run_unit_test.sh  //test/lambda/feed/feed_post:go_default_test       UserAuth
./run_unit_test.sh  //test/lambda/feed/get_feed_post:go_default_test   UserAuth
./run_unit_test.sh  //test/lambda/feed/get_recent_posts:go_default_test UserAuth
./run_unit_test.sh  //test/lambda/feed/get_batch_posts:go_default_test AdminAuth

./run_unit_test.sh  //test/lambda/feed/attach_session:go_default_test  UserAuth
./run_unit_test.sh  //test/lambda/feed/get_session:go_default_test  UserAuth

./run_unit_test.sh  //test/lambda/feed/refuel:go_default_test UserAuth
./run_unit_test.sh  //test/lambda/feed/dev_refuel:go_default_test AdminAuth

./run_unit_test.sh  //test/lambda/feed/feed_upvote:go_default_test UserAuth
./run_unit_test.sh  //test/lambda/feed/get_recent_votes:go_default_test UserAuth

./run_unit_test.sh  //test/lambda/feed/feed_token_generator:go_default_test AdminAuth
./run_unit_test.sh  //test/lambda/feed/reset_actor_fuel:go_default_test AdminAuth

./run_unit_test.sh  //test/lambda/feed/add_tracked_wallet_addresses:go_default_test UserAuth
./run_unit_test.sh  //test/lambda/feed/get_tracked_wallet_addresses:go_default_test UserAuth
./run_unit_test.sh  //test/lambda/feed/delete_tracked_wallet_addresses:go_default_test UserAuth
